      ...
      <Main>
        ...
        >
          <div ref={nodeRef} className="group grid items-center">
            ...
            <h1 className="self-end text-right font-mono font-normal leading-relaxed text-transparent text-4xl bg-clip-text bg-gradient-to-br from-purple to-yellow italic mb-4 lg:animate-to-bottom cursor-grab active:cursor-grabbing  selection:text-yellow active:from-blue active:to-green lg:h-24 lg:text-6xl">
              &#60;Greetings&#47;&#62;
            </h1>
          </div>
        </Draggable>

        <span className="justify-self-end  text-xl leading-relaxed mb-4  selection:text-yellow selection:bg-purple ">
          I'm Monica
        </span>

        <span className="pl-2  max-w-screen-sm text-right text-lg selection:text-yellow selection:bg-purple">
